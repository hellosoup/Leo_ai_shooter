	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 worldToObjDir94 = normalize( mul( GetWorldToObjectMatrix(), float4( _WindAxisXZ, 0 ) ).xyz );
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 panner82 = ( ( _TimeParameters.x * 1.0 ) * float2( 0.12,0 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				float simplePerlin3D80 = snoise( float3( panner82 ,  0.0 )*3.0 );
				simplePerlin3D80 = simplePerlin3D80*0.5 + 0.5;
				float2 panner102 = ( ( _TimeParameters.x * 0.6 ) * float2( -0.1,0.1 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				...
				float3 rotatedValue59 = RotateAroundAxis( float3(0,0,0), inputMesh.positionOS, normalize( worldToObjDir94 ), radians( ( (-0.4 + (( saturate( lerpBlendMode110 )) - 0.0) * (0.6 - -0.4) / (1.0 - 0.0)) * 30.0 ) ) );
				...
				#endif
				float3 vertexValue = ( ( float3( texCoord53 ,  0.0 ) * ( rotatedValue59 - inputMesh.positionOS ) ) * _WindStrength );
						...
						)
			{
				...
				float2 texCoord7 = packedInput.interp03.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult32 = lerp( temp_output_47_0 , float4( ( desaturateVar46 * _TopBrightness ) , 0.0 ) , saturate( pow( texCoord7.y , abs( 2.93 ) ) ));
				...
				surfaceDescription.Albedo = ( lerpResult32 * 1.0 ).rgb;
				...
				surfaceDescription.Smoothness = ( tex2D( _Metallic, uv_Metallic ).a * _Smoothness );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float desaturateDot46 = dot( desaturateInitialColor46, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar46 = lerp( desaturateInitialColor46, desaturateDot46.xxx, 0.25 );
				float2 texCoord7 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult32 = lerp( temp_output_47_0 , float4( ( desaturateVar46 * _TopBrightness ) , 0.0 ) , saturate( pow( texCoord7.y , abs( 2.93 ) ) ));
...
/*ASEBEGIN
Version=18921
1920;0;1920;1019;3169.595;-105.6009;2.078752;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-4130.376,1790.034;Inherit;False;Constant;_Float5;Float 5;8;0;Create;True;0;0;0;False;0;False;-80;-80;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;151;-4281.971,2045.849;Inherit;False;Property;_WindNoiseScale;Wind Noise Scale;8;0;Create;True;0;0;0;False;0;False;1;1;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-4189.767,1357.407;Inherit;False;Constant;_Float3;Float 3;7;0;Create;True;0;0;0;False;0;False;-80;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;104;-3922.606,1903.47;Inherit;False;Constant;_Float6;Float 6;7;0;Create;True;0;0;0;False;0;False;0.6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-3960.749,1478.014;Inherit;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;52;-2075.121,-1231.338;Inherit;False;1982.951;1064.909;Top-down gradient;19;43;42;31;20;21;7;51;50;49;32;37;44;46;47;48;1;154;155;169;Main Color Gradient;0.5744526,1,0,1;0;0
Node;AmplifyShaderEditor.SamplerNode;1;-2038.421,-1147.013;Inherit;True;Property;_MainTex;Base Color;0;0;Create;False;0;0;0;False;0;False;-1;None;276b1d90ab804824f908cce084bfcc6e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;154;-2039.649,-949.5735;Inherit;False;Property;_Color;Color;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.8671677,0.9433962,0.6541474,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1921.934,-783.3615;Inherit;False;Property;_MainTextureBrightness;Main Texture Brightness;4;0;Create;True;0;0;0;False;0;False;0.5;0.8;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-2641.084,1828.644;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;30;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;155;-1690.846,-1061.823;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-1581.317,-909.5185;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1965.668,-372.427;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;2.93;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;65;-2554.455,1349.107;Inherit;False;Property;_WindAxisXZ;Wind Axis (X, Z);7;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RadiansOpNode;71;-2114.752,1603.683;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TransformDirectionNode;94;-2198.782,1453.186;Inherit;False;World;Object;True;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.AbsOpNode;169;-1778.04,-367.6376;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;78;-2140.25,1681.637;Inherit;False;Constant;_Vector1;Vector 1;7;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WireNode;50;-1367.996,-1019.894;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;7;-1926.235,-667.7405;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;51;-1082.216,-1040.683;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PowerNode;20;-1617.127,-591.9515;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DesaturateOpNode;46;-1321.747,-910.3685;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0.25;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1416.277,-783.5875;Inherit;False;Property;_TopBrightness;Top Brightness;5;0;Create;True;0;0;0;False;0;False;3;4;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;31;-1313.603,-593.3165;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;49;-805.3676,-1020.882;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-1072.503,-861.0815;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;146;-443.1703,1153.876;Inherit;False;Property;_WindStrength;Wind Strength;6;0;Create;True;0;0;0;False;0;False;0.5;0.7;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;32;-658.1567,-891.4754;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0.7783207,1,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-624.9127,-717.6314;Inherit;False;Constant;_Float4;Float 4;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-866.3923,235.0659;Inherit;True;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;-1;None;2ab8f9685d8dba54c98ae0fe770c253d;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-849.3923,461.3057;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0.77;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;167;-200.016,112.2415;Inherit;False;Constant;_Float7;Float 7;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-197.5381,248.5263;Inherit;False;Constant;_Float8;Float 8;11;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-374.9548,-803.8105;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-869.6678,-18.8577;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;44d4be3a88a229246b2351763b99080f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;156;0;42;0
WireConnection;156;1;2;0
WireConnection;156;4;167;0
WireConnection;156;7;4;0
WireConnection;156;9;1;4
WireConnection;156;10;168;0
WireConnection;156;11;145;0
ASEEND*/
//CHKSM=2D66A91142A4862B004B1C9E6306A04C6A908297